...
/// <reference path="../../test/contracts/mail.d.ts" />
import { MailersList, MailerContract, CompiledMailNode, DriverOptionsType, MessageComposeCallback } from '@ioc:Adonis/Addons/Mail';
...
export declare class Mailer<Name extends keyof MailersList> implements MailerContract<Name> {
     ...
     */
    sendCompiled(mail: CompiledMailNode): Promise<import("@ioc:Adonis/Addons/Mail").DriverResponseType<MailersList[Name]["implementation"]>>;
    /**
     * Sends email
     */
    send(callback: MessageComposeCallback, config?: DriverOptionsType<MailersList[Name]>): Promise<import("@ioc:Adonis/Addons/Mail").DriverResponseType<MailersList[Name]["implementation"]>>;
    /**
